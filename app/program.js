var os = require('os'); //ścieżka do bezpośrednich zasobów noda lub do paczek pobranych z internetu za pomocą NPM
var myModuleName = require('../modules/fullOSinfo'); //ścieżka relatywna do wlasnych modulów
